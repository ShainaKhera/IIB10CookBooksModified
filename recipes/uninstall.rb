...
#
# Un-installs all components required by IBM Integration Bus.
#
################################################################################

log "Un-Installing full development environment for IBM Integration Bus" do
  level :info
end
if platform?("ubuntu")
...
# Do the installs
#iib_install_mq; --Saurabh
#iib_install_runtime;
#iib_install_explorer; --Saurabh
